"""fig01_hook matplotlib template for Type D interpretable ML in finance.
...
def main() -> None:
    ...
    ax.set_title("Type D fig01_hook: interpretable ML exhibit")
    ax.set_xlabel("feature_rank")
    ax.set_ylabel("importance")
    ax.legend(frameon=False, loc="best")
    apply_style(ax)
    out = Path("output/figures/typeD_fig01_hook.png")

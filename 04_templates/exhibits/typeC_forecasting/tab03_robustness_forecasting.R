# Table 3 robustness template for Forecasting.
...
m1 <- feols(loss_difference ~ forecast_signal, data = df)
...
modelsummary(
  models,
  output = "output/tables/tab03_robustness_forecasting.html",
  notes = rs_table_note(dv = "forecast loss", sample = "<sample>", source = "<source_script>", inference = "<se_type>")
)
